...
Secretaire::Secretaire(QString nom,QString prenom,int cin,int gsm,QString datenai,QString adresse,int service)
{
    this->nom=nom;
    this->prenom=prenom;
    this->cin=cin;
...
int Secretaire::get_service(){return service;};
        ...
        else if (prenom!=""&&first==0)
          {
            ...
            first=1 ;
             ...
             else if (gsm!=0 && first==0)
             {
               ...
               query.bindValue(":service",service);
               if(service!=0&& first!=0)
                   editer+=" ,SERVICE = :service" ;
               else if (service!=0 && first==0)
               {
                  editer+=" SERVICE = :service" ;
                  first=1 ;
               }
